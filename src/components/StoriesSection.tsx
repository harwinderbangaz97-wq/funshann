        ...
        >
          <div
            className={`relative w-[72px] h-[72px] rounded-full p-1 flex items-center justify-center transition-all group-hover:shadow-lg ${
              hasUserStory
                ? 'bg-gradient-to-tr from-[#5B9DFF] via-blue-500 to-cyan-400 p-[2.5px]'
                : 'neu-raised p-1'
            }`}
          >
